...
@property (nonatomic, weak) IBOutlet UISlider * __null_unspecified slider;
...
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified roundLabel;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)showAlert;
- (IBAction)sliderMoved:(UISlider * __nonnull)slider;
- (IBAction)startOver;
- (void)startNewGame;
- (void)startNewRound;
- (void)updateLabels;
